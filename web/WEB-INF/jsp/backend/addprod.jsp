    ...
    <div class="row">
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
            <div class="sidebar-sticky">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="${pageContext.request.contextPath}/backend/addprod">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
            <div class="table-responsive">
                <form name="prodForm" action="${pageContext.request.contextPath}/backend/addProd" method="post" enctype="multipart/form-data">          
               		<div class="form-group">
                      <label for="exampleFormControlInput1">商品ID</label>
                      <input id="id" name="id" type="text" class="form-control"  placeholder="请输入商品ID" />
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input id="price" name="price"   type="text" class="form-control"  placeholder="请输入商品价格"/>
                    </div>
                    <div class="form-group">
                      <label for="exampleFormControlInput1">商品库存</label>
                      <input id="pnum"  name="pnum" type="text" class="form-control" placeholder="请输入商品库存"/>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <textarea id="description" name="description" class="form-control" rows="3" placeholder="请输入商品描述"></textarea>
                    </div>
                    <p id="msg" style="color:red">
					  ${msg}
					</p>
                     <button style="margin-bottom:30px" type="button" onclick="checkForm()" class="btn btn-primary">添加</button> 
