...
<html>
	...
	<body>
		...
		<%@include file="_head.jsp" %>
			...
			<div id="line5">
				<span id="line5_1">
					<img src="${pageContext.request.contextPath}/img/index/icon_g1.png"/>&nbsp;&nbsp;666666
				</span>
				<span id="line5_2">
				...
				<span id="line5_4">
					<img src="${pageContext.request.contextPath}/img/index/icon_g4.png"/>&nbsp;&nbsp;666家维修网点 全国联保
				</span>
			</div>
