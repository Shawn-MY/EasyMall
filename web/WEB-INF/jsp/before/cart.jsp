	...
	//	3)设置全选和全不选
		...
		*/
				$(".delProd").click(function(){
					...
					$.post("${pageContext.request.contextPath}/cart/cartadd",{"pid":pid, "buyNum":-1});			
					//3.删除当前页面中的商品
	...
	<%@ include file="_head.jsp" %>
		<div id="wrap">
			...
			<ul class="prods">
				...
				<li class="li_prod">
					<img src="${pageContext.request.contextPath}/img/${entry.key.imgurl }" width="90" height="90" class="prodimg" />
			...
			<div id="total">
				...
				<div id="total_2">	
					<a id="goto_order" href="${pageContext.request.contextPath}/order_add">去结算</a>
				</div>
			</div>
		</div>
